    ...
    public void initialize() {
        try {
            if(loginBO.existLogins().size() == 0){
                ...
                loginBO.saveLoginAccess(new LoginDTO("Theekshana","admin","Abc1234","Admin"));
                loginBO.saveLoginAccess(new LoginDTO("Theekshana","Theek23","Abc1234","Receptionist"));
                loginBO.saveLoginAccess(new LoginDTO("Theekshana","Theek28","Abc1234","Receptionist"));
